...
def process_images(p: StableDiffusionProcessing) -> Processed:
    ...
    try:
        ...
        # and if after running refiner, the refiner model is not unloaded - weyui swaps back to main model here, if model over is present it will be reloaded afterwards
