...
parser.add_argument("-f", action='store_true', help=argparse.SUPPRESS)  # allows running as root; implemented outside of weyui
...
parser.add_argument("--allow-code", action='store_true', help="allow custom script execution from weyui")
...
parser.add_argument("--hide-ui-dir-config", action='store_true', help="hide directory configuration from weyui", default=False)
...
parser.add_argument("--autolaunch", action='store_true', help="open the weyui URL in the system's default browser upon launch", default=False)
...
parser.add_argument("--api", action='store_true', help="use api=True to launch the API together with the weyui (use --noweyui instead for only the API)")
parser.add_argument("--api-auth", type=str, help='Set authentication for API like "username:password"; or comma-delimit multiple like "u1:p1,u2:p2,u3:p3"', default=None)
parser.add_argument("--api-log", action='store_true', help="use api-log=True to enable logging of all API requests")
parser.add_argument("--noweyui", action='store_true', help="use api=True to launch the API instead of the weyui")
