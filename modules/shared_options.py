...
options_templates.update(options_section(('saving-images', "Saving images/grids"), {
    ...
    "samples_filename_pattern": OptionInfo("", "Images filename pattern", component_args=hide_dirs).link("wiki", "https://github.com/AUTOMATIC1111/stable-diffusion-weyui/wiki/Custom-Images-Filename-Name-and-Subdirectory"),
    ...
    "grid_zip_filename_pattern": OptionInfo("", "Archive filename pattern", component_args=hide_dirs).link("wiki", "https://github.com/AUTOMATIC1111/stable-diffusion-weyui/wiki/Custom-Images-Filename-Name-and-Subdirectory"),
    ...
    "clean_temp_dir_at_start": OptionInfo(False, "Cleanup non-default temporary directory when starting weyui"),

    "save_incomplete_images": OptionInfo(False, "Save incomplete images").info("save images that has been interrupted in mid-generation; even if not saved, they will still show up in weyui output."),
}))
...
options_templates.update(options_section(('saving-to-dirs', "Saving to a directory"), {
    ...
    "directories_filename_pattern": OptionInfo("[date]", "Directory name pattern", component_args=hide_dirs).link("wiki", "https://github.com/AUTOMATIC1111/stable-diffusion-weyui/wiki/Custom-Images-Filename-Name-and-Subdirectory"),
...
options_templates.update(options_section(('system', "System"), {
    "auto_launch_browser": OptionInfo("Local", "Automatically open weyui in browser on startup", gr.Radio, lambda: {"choices": ["Disable", "Local", "Remote"]}),
...
options_templates.update(options_section(('sd', "Stable Diffusion"), {
    ...
    "CLIP_stop_at_last_layers": OptionInfo(1, "Clip skip", gr.Slider, {"minimum": 1, "maximum": 12, "step": 1}, infotext="Clip skip").link("wiki", "https://github.com/AUTOMATIC1111/stable-diffusion-weyui/wiki/Features#clip-skip").info("ignore last layers of CLIP network; 1 ignores none, 2 ignores one layer"),
...
options_templates.update(options_section(('optimizations', "Optimizations"), {
    ...
    "s_min_uncond": OptionInfo(0.0, "Negative Guidance minimum sigma", gr.Slider, {"minimum": 0.0, "maximum": 15.0, "step": 0.01}).link("PR", "https://github.com/AUTOMATIC1111/stable-diffusion-weyui/pull/9177").info("skip negative prompt for some steps when the image is almost ready; 0=disable, higher=faster"),
    "token_merging_ratio": OptionInfo(0.0, "Token merging ratio", gr.Slider, {"minimum": 0.0, "maximum": 0.9, "step": 0.1}, infotext='Token merging ratio').link("PR", "https://github.com/AUTOMATIC1111/stable-diffusion-weyui/pull/9256").info("0=disable, higher=faster"),
...
options_templates.update(options_section(('sampler-params', "Sampler parameters"), {
    ...
    'always_discard_next_to_last_sigma': OptionInfo(False, "Always discard next-to-last sigma", infotext='Discard penultimate sigma').link("PR", "https://github.com/AUTOMATIC1111/stable-diffusion-weyui/pull/6044"),
    'sgm_noise_multiplier': OptionInfo(False, "SGM noise multiplier", infotext='SGM noise multplier').link("PR", "https://github.com/AUTOMATIC1111/stable-diffusion-weyui/pull/12818").info("Match initial noise to official SDXL implementation - only useful for reproducing images"),
